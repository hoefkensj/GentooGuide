...
git -C /mnt/install/git clone https://anongit.gentoo.org/git/proj/gentoolkit.git
...
git -C /mnt/install/git clone fd https://github.com/sharkdp/fd
git -C /mnt/install/git clone ripgrep https://github.com/BurntSushi/ripgrep
git -C /mnt/install/git clone bat https://github.com/sharkdp/bat
git -C /mnt/install/git clone exa https://github.com/ogham/exa
git -C /mnt/install/git clone tldr https://github.com/tldr-pages/tldr
git -C /mnt/install/git clone fzf https://github.com/junegunn/fzf
git -C /mnt/install/git clone zoxide https://github.com/ajeetdsouza/zoxide
```
